...
void Magic_Items::treasure_menu()
{
  ...
  while (choice != 5)
  {
    ...
    case 1:
      ...
      {
      case 1:
        GenerateIndividualTreasureCR_0_4();
        break;
      case 2:
        GenerateIndividualTreasureCR_5_10();
        break;
      case 3:
        GenerateIndividualTreasureCR_11_16();
        break;
      case 4:
        GenerateIndividualTreasureCR_17();
      default:
        break;
      }
      choice = 0;
    ...
    case 2:
      ...
      {
      case 1:
        GenerateHoardTreasureCR_0_4();
        break;
      case 2:
        GenerateHoardTreasureCR_5_10();
        break;
      case 3:
        GenerateHoardTreasureCR_11_16();
        break;
      case 4:
        GenerateHoardTreasureCR_17();
      default:
        break;
      }
      choice = 0;
...
Gear Magic_Items::TableA(const char &r)
{
  ...
  { //was cantrip changed to 1st lvl
...
string Magic_Items::GenerateGemstone(const int &amount, const int &value) const
{
  ...
  if (fileOfGems.is_open())
  {
    ...
    { //go down into file appropriate amount
      if (value == 10)
      {
      ...
      setvalue = true;
      auto len = fileOfGems.tellg(); //get current position - snapshot of place in file
      for (auto i = 0; i < chosenSeed; i++)
      { //go over to the proper gem rolled based on seed
        fileOfGems.ignore(numeric_limits<streamsize>::max(), ';');
      }
      ...
      else
      {
        ...
        { //found first duplicate gemname on the list - not last item either
...
string Magic_Items::GenerateArt(const int &amount, const int &value) const
{
  ...
  if (fileOfArt.is_open())
  {
    ...
    auto chosenSeed = 0;
    for (int i = 0; i < amount; i++)
    { //go down into file appropriate amount and choose a proper seed
      if (value == 25)
      {
        chosenSeed = randomNumber(0, 9);
        if (!setvalue)
      ...
      setvalue = true;
      auto len = fileOfArt.tellg(); //get current position  //snapshot of place in file
      for (auto i = 0; i < chosenSeed; i++)
      { //go over to the proper Art rolled
        fileOfArt.ignore(numeric_limits<streamsize>::max(), ';');
      }
      ...
      else
      {
        ...
        if (find_position != string::npos)
        { //found first duplicate Artname on the list - not last item either
